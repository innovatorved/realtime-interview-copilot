  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col glass-card overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar px-4 py-4 sm:px-5 sm:py-5">
        {!completion ? (
          <div className="h-full min-h-[80px] flex flex-col items-center justify-center text-neutral-700 space-y-2 px-2">
            <div className="w-11 h-11 rounded-lg bg-white/[0.03] flex items-center justify-center border border-white/[0.04]">
