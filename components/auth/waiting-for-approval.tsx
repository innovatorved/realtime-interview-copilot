...
export function WaitingForApproval({ email }: { email?: string }) {
  ...
  const handleSendReply = async () => {
    ...
    posthog.capture("support_message_sent", { email, parentId: activeThreadId });
    setReply("");
              ...
              <ul className="flex-1 min-h-0 overflow-y-auto custom-scrollbar">
                ...
                {!isLoading && sortedThreads.length === 0 && (
                  <li
                    ...
                    style={{ color: TOKEN.steel, fontSize: 11.5 }}
                  >
                    No conversations yet. Send the admin a quick note about who
                    you are or why you need access.
                  </li>
                )}
          ...
          <div className="flex flex-col flex-1 min-h-0">
            ...
            >
              ...
              {!threadLoading && threadMessages.length === 0 && (
                <p style={{ color: TOKEN.steel, fontSize: 11.5, padding: "4px" }}>
                  No messages.
                </p>
              )}
